...
<html>
  <head>
    ...
    <link
      rel="shortcut icon"
      href="asset/images/1565530174706-1-125x128.png"
      type="image/x-icon"
    />
    <meta name="description" content="Website Generator Description" />
    <title>Jurusan Rekayasa Perangkat Lunak</title>
    <!-- favicon -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mt-5">
            <div class="container">
              <h1 class="title">Rekayasa Perangkat Lunak</h1>
              <p class="lead">
                Mempelajari tentang Pengembangan Perangkat Lunak seperti Web
                Development,Mobile Development dan Aspek" penting lainya yang
                berkaitan dengan Rekayasa Perangkat Lunak
              </p>
              <div class="accordion" id="accordionPanelsStayOpenExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                    ...
                    >
                      <img
                        src="./asset/Ilustrasi-Icon/major/web-development.png"
                        alt="Web Developer"
                      />
                      Web Dev
                    </button>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                    ...
                    >
                      <img
                        src="./asset/Ilustrasi-Icon/major/app-development.png"
          ...
          <div class="col-md-12 py-5">
            <div class="row">
              <div class="col-md-4 mb-md-0 mb-4">
                <img
                  src="../../Ilustrasi-Icon/kawung-logo.png"
