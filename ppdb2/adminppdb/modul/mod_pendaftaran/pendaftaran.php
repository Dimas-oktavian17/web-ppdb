...
?>
	<section class="content-header">
		<div class="row">
			<div class="col-xs-6">
				<span style="font-size:24px;">DATA SEMUA PENDAFTAR PPDB</span>
			</div>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><?php if($myData['nm_p_siswa']=="Sekolah Menengah Kejuruan (SMK YASHIKA)") echo "SMK"; else echo "MA"; ?></td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<dl class="dl-horizontal">
					<dt>Nama Sekolah Asal</dt> <dd><?php echo $myData['nm_sekolah']; ?></dd>
					<dt>Alamat Sekolah Asal</dt> <dd><?php echo $myData['alamat_sekolah']; ?></dd>
					<dt>NO KIP</dt> <dd><?php echo $myData['nisn']; ?></dd>
				</dl>
