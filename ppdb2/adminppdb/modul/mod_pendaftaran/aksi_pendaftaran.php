		...
		<table border="1">
			<thead>
				...
				<tr style="background: #cccccc;"><b>
					...
					<td align="center"><b>UNIT PILIHAN</b></td>
					<td align="center"><b>STATUS MONDOK</b></td>
					...
					<td align="center"><b>ALAMAT SEKOLAH</b></td>
					<td align="center"><b>NO KIP</b></td>
...
?>
					<tr>
						...
						<td><?php if($a['nm_p_siswa']=="Sekolah Menengah Kejuruan (SMK YASHIKA)") echo "SMK"; else echo "MA"; ?></td>
						<td><?php if($a['stat_mondok']=="Mondok") echo "Mondok"; else echo "Tidak"; ?></td>
						<td><?php echo $a['jk']; ?></td>
