...
<section class="content">
	...
	<center>
		<h2>REKAPITULASI DATA PPDB MASUK<brh2>
	</center>
		<div class="row">
	...
	<!--</div>-->
		...
		var myChart = new Chart(ctx, {
			type: 'pie',
			data: {
				labels: ["Mondok", "Tidak Mondok"],
				datasets: [{
					label: '',
					data: [
					<?php 
					$jumlah_laki = mysqli_query($colok,"select * from siswa where stat_mondok='Mondok'");
					echo mysqli_num_rows($jumlah_laki);
					?>, 
					<?php 
					$jumlah_perempuan = mysqli_query($colok,"select * from siswa where stat_mondok='Tidak Mondok'");
					echo mysqli_num_rows($jumlah_perempuan);
					?>
					],
					backgroundColor: [
   ...
   <!--     <div class="col-md-3 col-xs-6">-->
			...
			<!--	<div class="inner">-->
					<!--<h3>-->
					<?php
					$q = mysqli_query($colok, "SELECT COUNT(*) AS jml_pendaftar FROM siswa where status='DITERIMA' AND nm_p_siswa='Madrasah Aliyah (MA AL-HIKMAH)'");
					$r = mysqli_fetch_array($q);
					echo $r['jml_pendaftar'];
					?>
				<!--	</h3>-->
				...
				<!--	<i class="fa fa-users"></i>-->
				<!--</div>-->
		<!--		<a href="main.php?module=pendaftar-ma" class="small-box-footer">Lihat Data <i class="fa fa-arrow-circle-right"></i></a>-->
		<!--	</div>-->
		<!--</div><!-- ./col -->
        ...
        <div class="col-md-3 col-xs-6">
			...
			<div class="small-box bg-aqua">
				<div class="inner">
					<h3>
					<?php
					$q = mysqli_query($colok, "SELECT COUNT(*) AS jml_pendaftar FROM siswa where status='DITERIMA' AND nm_p_siswa='Sekolah Menengah Kejuruan (SMK YASHIKA)'");
					$r = mysqli_fetch_array($q);
					echo $r['jml_pendaftar'];
					?>
					</h3>
				...
				<a href="main.php?module=pendaftar-smk" class="small-box-footer">Lihat Data <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div><!-- ./col -->
   ...
   <!--     <div class="col-md-3 col-xs-6">-->
			...
			<!--		<h3>-->
					<?php
					$q = mysqli_query($colok, "SELECT COUNT(*) AS jml_pendaftar FROM siswa where status='DITERIMA' AND stat_mondok='Mondok'");
					$r = mysqli_fetch_array($q);
					echo $r['jml_pendaftar'];
					?>
		<!--			</h3>-->
		...
		<!--			<i class="fa fa-users"></i>-->
		<!--		</div>-->
		<!--		<a href="main.php?module=pendaftar-mondok" class="small-box-footer">Lihat Data <i class="fa fa-arrow-circle-right"></i></a>-->
		<!--	</div>-->
		<!--</div><!-- ./col -->
		...
		<!--			<h3>-->
					<?php
					$q = mysqli_query($colok, "SELECT COUNT(*) AS jml_pendaftar FROM siswa where status='DITERIMA' AND stat_mondok='Tidak Mondok'");
					$r = mysqli_fetch_array($q);
					echo $r['jml_pendaftar'];
					?>
		<!--			</h3>-->
		...
		<!--			<i class="fa fa-users"></i>-->
		<!--		</div>-->
		<!--		<a href="main.php?module=pendaftar-tidak-mondok" class="small-box-footer">Lihat Data <i class="fa fa-arrow-circle-right"></i></a>-->
		<!--	</div>-->
		<!--</div><!-- ./col -->
