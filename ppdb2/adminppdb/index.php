...
<html>
  <head>
    ...
    <title>PPDB Online SMK Kawung 1 Surabaya Administrator</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">Admin <b>PPDB Online</b>
      </div><!-- /.login-logo -->
	  ...
	  <p>&nbsp;</p>
	  <p class="text-center">&copy; 2020 <a href="http://digitalwebindonesia.web.id/" target="_blank"><b>SMK Kawung 1 surabaya</b></a></p>
    </div><!-- /.login-box -->
