...
<script>
    $.ajax({
        ...
        url: "mod_sekolah/crud_sekolah.php?pg=get_provinsi", // Isi dengan url/path file php yang dituju
    ...
    $("#provinsi").change(function() {
        ...
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "mod_sekolah/crud_sekolah.php?pg=get_kabupaten", // Isi dengan url/path file php yang dituju
    ...
    $("#kabupaten").change(function() {
        ...
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "mod_sekolah/crud_sekolah.php?pg=get_kecamatan", // Isi dengan url/path file php yang dituju
    ...
    $("#kecamatan").change(function() {
        ...
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "mod_sekolah/crud_sekolah.php?pg=get_sekolah", // Isi dengan url/path file php yang dituju
    ...
    $('#form-grab').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'mod_sekolah/crud_sekolah.php?pg=grab_sekolah',
            data: $(this).serialize(),
            success: function(data) {
                console.log(data);
