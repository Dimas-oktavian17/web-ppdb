    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4>Setting Biaya SPP dan Pembangunan</h4>
            ...
            <div class="card-body">
                <form id="form-spp">
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Biaya SPP</label>
                        <div class="col-sm-6 col-md-9">
                            <input type="text" name="spp" class="form-control" value="<?= $setting['spp'] ?>" required>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Uang Bangunan</label>
                        <div class="col-sm-6 col-md-9">
                            <input type="text" name="spb" class="form-control" value="<?= $setting['spb'] ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <span class="badge badge-danger">Tidak Wajib</span>
                                        <?php } ?>
                                    </td>
                                    <td>
...
<script>
    $(document).ready(function() {
        $('#form-spp').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'mod_biaya/crud_biaya.php?pg=simpanspp',
                data: $(this).serialize(),
                beforeSend: function() {
