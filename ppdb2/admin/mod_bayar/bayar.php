                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } elseif ($bayar['verifikasi'] == 2) { ?>
                                                    <span class="badge badge-warning">Proses Checking</span>
                                                <?php } else { ?>
                                            ...
                                            <td>
                                                <?php if ($bayar['bukti'] <> null) { ?>
                                                    <div class="gallery gallery-fw" data-item-height="30">
                                                        <div class="gallery-item" data-image="../user/mod_bayar/<?= $bayar['bukti'] ?>" data-title="Image 1"></div>
            ...
            <div class="modal-content">
                ...
                <form id="form-bayar">
                    <div class="modal-body">
                        ...
                        <input type="hidden" class="form-control" name="id" value="<?= $siswa['id_daftar'] ?>">
                        <?php
