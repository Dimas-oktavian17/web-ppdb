            ...
            <div class="card-body">
                <?php if ($setting['pembayaran'] <> 1) { ?>
                    <center>
                        ...
                        <?php } ?>
                        <br>Tombol cetak formulir akan aktif setelah diverifikasi panitia
                    </center><br>
                <?php  } else { ?>
                    <div class="alert alert-warning alert-dismissible show fade">
                        <div class="alert-body">
                            ...
                            Untuk mencetak formulir ada dimenu pembayaran.
                        </div>
                    </div>
                <?php  } ?>
                            ...
                            <form id="form-datadiri">
                                ...
                                <!-- <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        ...
                                        <input type="number" name="anak_yayasan" class="form-control" value="<?= $siswa['anak_yayasan'] ?>">
                                    </div>
                                    <small> dalam Yayasan Sekolah (kosongkan jika bukan)</small>
                                </div> -->
                                <div class="form-group row mb-2">
                        ...
                        <div class="tab-pane fade" id="berkas3" role="tabpanel" aria-labelledby="berkas">
                            <form id="form-berkas">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <div class="custom-file">
                                            <input type="file" name="file-kk" class="custom-file-input">
                                            <label class="custom-file-label">Choose File</label>
                                        </div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <div class="custom-file">
                                            <input type="file" name="file-ktp" class="custom-file-input">
                                            <label class="custom-file-label">Choose File</label>
                                        </div>
                                        <div class="form-text text-muted">Upload yang diperbolehkan ukuran maksimun 2Mb</div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <div class="custom-file">
                                            <input type="file" name="file-akte" class="custom-file-input">
                                            <label class="custom-file-label">Choose File</label>
                                        </div>
                                        <div class="form-text text-muted">Upload yang diperbolehkan ukuran maksimun 2Mb</div>
...
<script>
    $(document).ready(function() {
        $.ajax({
            ...
            url: "mod_formulir/crud_formulir.php?pg=get_provinsi", // Isi dengan url/path file php yang dituju
    ...
    $("#provinsi").change(function() {
        ...
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "mod_formulir/crud_formulir.php?pg=get_kabupaten", // Isi dengan url/path file php yang dituju
    ...
    $("#kabupaten").change(function() {
        ...
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "mod_formulir/crud_formulir.php?pg=get_kecamatan", // Isi dengan url/path file php yang dituju
    ...
    $("#kecamatan").change(function() {
        ...
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "mod_formulir/crud_formulir.php?pg=get_desa", // Isi dengan url/path file php yang dituju
    ...
    $(document).ready(function() {
        ...
        $('#form-berkas').on('submit', function(e) {
            ...
            $.ajax({
                type: 'post',
                url: 'mod_formulir/crud_formulir.php?pg=simpanberkas',
                data: new FormData(this),
                processData: false,
                contentType: false,
                cache: false,
