      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mt-5">
            <div class="container">
              <h1 class="title">Akutansi Keuangan Lembaga</h1>
              <p class="lead">
                Mempelajari tentang Akuntansi Keuangan,Adminstarsi Pajak dan
                Aspek" lain yang berkaitan dengan Akutansi
              </p>
              <div class="accordion" id="accordionPanelsStayOpenExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                    ...
                    >
                      <img
                        src="./asset/Ilustrasi-Icon/major/budget.png"
                        alt="Akutansi Keuangan"
                      />
                      Akuntansi Keuangan
                    </button>
                  </h2>
                  ...
                  >
                    <div class="accordion-body">
                      Siswa nantinya mempelajari proses penyusunan laporan
                      keuangan yang digunakan perusahaan untuk menunjukkan
                      kinerja dan posisi keuangannya kepada orang-orang di luar
                      perusahaan, termasuk investor, kreditur, pemasok, dan
                      pelanggan.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                    ...
                    >
                      <img
                        src="./asset/Ilustrasi-Icon/major/audit.png"
                        alt="Adminstrasi Pajak"
                      />
                      Adminstarsi Pajak
                    </button>
                  </h2>
                  ...
                  >
                    <div class="accordion-body">
                      Siswa akan mempelajari perpajakan, yang paling dasar yaitu
                      pengantar perpajakan, Pajak Daerah dan Retribusi Daerah
                      (PDRD), Ketentuan Umum Perpajakan (KUP), Pajak Pertambahan
                      Nilai dan Pajak Penjualan Atas Barang Mewah (PPN dan
                      PPnBM), Pajak Penghasilan (PPh), Pemotongan dan Pemungutan
                      PPh
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      Lulusan Akutansi banyak bekerja pada posisi Akuntan
                      Publik,Account Officer (AO),Financial Analyst,internal
          ...
          <div class="col-md-6">
            <figure class="figure">
              <img
                ...
                data-aos="fade-up"
                alt="Akuntansi keuangan Lembaga"
              />
            </figure>
          </div>
        </div>
